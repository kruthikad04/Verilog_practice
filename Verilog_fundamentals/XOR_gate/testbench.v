...
module tb_xor_gate_df;
    ...
    // Outputs are declared as wires to capture the dataflow values
    wire out;
    ...
    initial begin
        ...
        $dumpfile("xor_df_waveform.vcd");
        $dumpvars(0, tb_xor_gate_df);

        // Case 1: Inputs match (0, 0) -> Expect 0
        a = 0; b = 0;
        #10;

        // Case 2: Inputs differ (0, 1) -> Expect 1
        a = 0; b = 1;
        #10;

        // Case 3: Inputs differ (1, 0) -> Expect 1
        a = 1; b = 0;
        #10;

        // Case 4: Inputs match (1, 1) -> Expect 0
        a = 1; b = 1;
        #10;
